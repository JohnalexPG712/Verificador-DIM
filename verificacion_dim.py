...
class ValidadorDeclaracionImportacionCompleto:
    def __init__(self):
        ...
        self.patrones = {
            ...
            "44. No. Documento de Transporte": [r"44\s*\.?\s*Documento\s*de\s*transporte[\s\S]*?No\.?\s*[A-Z0-9\-]{3,}[\s\S]*?No\.?\s*((?:(?=[A-Z0-9-]*[A-Z])[A-Z0-9\s*]+(?:-[A-Z0-9]+)*)|(?:[A-Z]+[0-9]+(?:-[A-Z]+)?)|(?:[A-Z0-9]{7,})|(?:[0-9]{6,11}))(?:\s|[0-9]{4}|$)"],
